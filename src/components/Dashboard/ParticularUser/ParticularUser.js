        ...
        <div className="col-lg-6 col-md-12 col-sm-12">
            <div className="card mb-3 w-100" style={{ width: "28rem", boxSizing: "border-box", padding: "20px" }}>
                <div className="row">
                    ...
                    <img style={{ width: "150px", height: "150px" }} className="card-img-top align-self-center" src={`data:image/jpeg;base64,${newImage.img}`} alt="" />
                    </div>
                ...
                <div className="card-body">
                    <div className="row">
                        ...
                        <h5 className="card-title fw-bold">{particularUser.service}</h5>
                            ...
                            <h5 className="card-text w-25" style={{border: "1px solid gray"}}>Price: {particularUser.price}</h5>
                        </div>
                    </div>
                </div>
            </div>
